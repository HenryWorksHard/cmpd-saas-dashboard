...
const phases: Phase[] = [
  ...
  },
  {
    ...
    status: 'pending',
    tasks: [
      { name: 'Create Stripe account & products', done: false },
      { name: 'Set up subscription tiers (Starter/Pro/Studio/Gym)', done: false },
      { name: 'Build webhook endpoint', done: false },
      { name: 'Handle subscription lifecycle events', done: false },
      { name: 'Add billing page to admin portal', done: false },
  ...
  },
  {
    ...
    status: 'pending',
    tasks: [
      { name: 'Trainer signup/onboarding flow', done: false },
      { name: 'Organization settings page', done: false },
      { name: 'Billing & subscription management UI', done: false },
      { name: 'Platform Management section (super_admin)', done: false },
      { name: 'All trainers list view', done: false },
      { name: 'Revenue dashboard', done: false },
      { name: 'Impersonate trainer feature', done: false },
      { name: 'Role-based sidebar/permissions', done: false },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    status: 'pending',
    tasks: [
      { name: 'Hero section & value prop', done: false },
      { name: 'Features showcase', done: false },
      { name: 'Pricing page with tier comparison', done: false },
      { name: 'Trainer signup CTA flow', done: false },
